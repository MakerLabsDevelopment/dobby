 ...
 * @internal
 */
export declare function bucketsCreate(api: GrpcConnection, name: string, isPrivate?: boolean, ctx?: ContextInterface): Promise<CreateObject>;
/**
 ...
 * @internal
 */
export declare function bucketsLinks(api: GrpcConnection, key: string, ctx?: ContextInterface): Promise<LinksObject>;
/**
 ...
 * @param key Unique (IPNS compatible) identifier key for a bucket.
 */
export declare function bucketsArchive(api: GrpcConnection, key: string, ctx?: ContextInterface): Promise<void>;
/**
