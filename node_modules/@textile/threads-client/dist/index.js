...
class Client {
     ...
     * ```
     */
    newCollectionFromObject(threadID, name, 
    // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
    obj, indexes) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * ```
     */
    updateCollection(threadID, name, 
    // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
    schema, indexes) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    newDBFromAddr(address, key, collections) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = new multiaddr_1.Multiaddr(Buffer.from(req.getAddr_asU8()))
                .stringTuples()
                .filter(([key]) => key === 406);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const addr of filtered) {
                ...
                req.setKey(typeof info.key === "string"
                    ? threads_core_1.ThreadKey.fromString(info.key).toBytes()
                    : info.key);
                if (collections !== undefined) {
                    req.setCollectionsList(collections.map((c) => {
                        const config = new pb.CollectionConfig();
    ...
    verify(threadID, collectionName, values) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            req.setInstancesList(list);
            const { transactionerror } = (yield this.unary(threads_pb_service_1.API.Verify, req));
